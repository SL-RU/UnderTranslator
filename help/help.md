...
- Enter: сохранить изменения(изменения отобразятся в таблице) в таблице и перейти к следующей ячейке.
...
#ДЛЯ ЗАПИСИ ИЗМЕНЕНИЙ В ФАЙЛ НЕОБХОДИМО СОХРАНИТЬ ПРОЕКТ FILE->SAVE
